 ...
 *
 * Configures the base HTTP request client pointing to the backend API.
 * Includes a request interceptor to automatically inject JWT tokens from localStorage.
 */
